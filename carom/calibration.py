...
import numpy as np
import cv2
import carom.pywgs84 as pywgs84

from carom.visualization import FrameVis
from carom.visualization import Visualizer
...
def test_joint_calib_2d(camera_id):
    ...
    prefixes = ['carla_eastbound', 'westbound', 'eastbound', 'northbound', 'southbound', 'osburn1004']
    ...
    #print("displaying image contents: ",img_bg)
